...
namespace Fitnesclubplus.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ServiceName,DurationMinutes,Price,GymId")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ServiceName,DurationMinutes,Price,GymId")] Service service)
        {
            if (id != service.Id)
            {
                return NotFound();
